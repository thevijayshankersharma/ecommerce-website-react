    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-lg relative animate-fade-in-up">
        ...
        <div className="mb-8 text-center sm:text-left">
          <h2 className="text-2xl font-bold font-heading text-gray-800">Add New Address</h2>
          <p className="text-gray-500 text-sm mt-1">Please enter your shipping details below.</p>
        </div>
