    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
                <div><Toaster /></div>
                <form onSubmit={handleSubmit} className="relative bg-white p-6 rounded shadow-md w-full max-w-md flex flex-col gap-4">
                    <Link to='/address'>
                    ...
                    <button type="submit" className="bg-red-500 text-white py-2 rounded hover:bg-red-600 transition">Update Address</button>
                </form>
            </div>
        </>
